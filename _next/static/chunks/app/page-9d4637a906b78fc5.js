(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    4604: (e, t, s) => {
      ...
      let d = {
        ...
        p = () => {
          ...
          return (0, a.jsx)("div", {
            ...
            children: (0, a.jsxs)("div", {
              className:
                "relative max-sm:mt-[135px] z-[21] w-full sm:w-[526px] lg:w-[1028px] max-w-[378px] sm:max-w-full lg:h-[404px] m-auto p-3.5 flex flex-col lg:flex-row gap-1.5 rounded-lg border border-white/10 bg-white/5 shadow-[inset_0px_0px_0px_6px_rgba(255,255,255,0.03)]",
              children: [
                (0, a.jsx)("div", {
                  className:
                    ...
                    (0, a.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, a.jsxs)("span", {
                          ...
                          children: [
                            "The most advanced AI infrastructure today with ",
                            "400",
                            "++ NVIDIA H100 GPUs and more",
                          ],
                        }),
                        (0, a.jsx)("button", {
                          className:
            ...
            (0, r.useEffect)(() => {
              ...
              let l = (e) => {
                ...
                null === (a = t.current) ||
                  ...
                  null === (A = t.current) ||
                    void 0 === A ||
                    A.on("click", "unclustered-point", (e) => {
      ...
      function Z() {
        return (0, a.jsx)("div", {
          ...
          children: (0, a.jsxs)("div", {
            className: "max-w-[1137px] mx-auto",
            style: {
                paddingBottom : '300px'                
            },
            children: [
              ...
              (0, a.jsx)(z, {
                data: [
                  ...
                  {
                    logo: "impossible_cloud_network.png",
              ...
              (0, a.jsx)(z, {
                data: [
                  ...
                  {
                    logo: "base_gradation.png",
                    url: "https://syfu.io/en",
                  },
                  {
                    logo: "zone9.png",
                    url: "https://bento.me/zone9",
                  },
                  {
                    logo: "dephy.png",
                    url: "https://dephy.io/",
      ...
      let q = () => {
        ...
        return (0, a.jsx)("div", {
          style: { fontFamily: "Inter, sans-serif" },
          className: "bg-black py-[96px] sm:py-[164px]",
          id: "backer",
          children: (0, a.jsxs)("div", {
            className: "max-w-[1137px] mx-auto",
            children: [
                    ...
                    children: e.slice(0, 3).map((e, t) =>
                      (0, a.jsx)(
                        K.default,
                        {
                          href: e.url,
                          className:
                            "rounded-[8px] w-full max-w-[280px] h-[80px] py-[12px] border border-[#333] flex items-center justify-center bg-black",
              ...
              (0, a.jsx)("div", {
                className:
                  "lg:hidden grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 justify-items-center px-6",
                children: e.map((e, t) =>
                  (0, a.jsx)(
                    K.default,
                    {
                      href: e.url,
                      className:
                        "rounded-[8px] w-full max-w-[280px] h-[53px] sm:h-[80px] px-[10px] py-[8px] sm:py-[12px] border border-[#333] flex items-center justify-center bg-black",
                      children: (0, a.jsx)(v.default, {
                        width: 158,
                        height: 49,
                        className: "max-h-[42px] sm:max-h-[49px]",
                        src: "/assets/icons/".concat(e.logo),
                        alt: "",
                      }),
                    },
      ...
      function Y() {
        let e = (0, o.useRouter)(),
          ...
          s =
            t && !isNaN(Number(t))
              ? Number(t).toLocaleString("vi-VN").replace(/\./g, ",")
              : "0";
        return (0, a.jsxs)("section", {
          className:
            "flex flex-col justify-center relative w-full max-h-screen",
          ...
          children: [
            ...
            (0, a.jsxs)("div", {
              className:
                "flex max-sm:flex-col absolute max-sm:-bottom-[130px] bottom-0 w-full justify-center items-center gap-[160px] max-sm:gap-2 text-white z-30 left-1/2 transform -translate-x-1/2 -translate-y-1/2",
              children: [
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    (0, a.jsxs)("span", {
                      style: {
                        ...
                        textShadow: "0px 0px 6px rgba(175, 255, 230, 1)",
                      },
                      children: ["400", "++"],
                    }),
                    (0, a.jsx)("span", {
            ...
            (0, a.jsx)(v.default, {
              className:
                "absolute left-1/2 max-sm:-bottom-[130px] max-sm:object-cover bottom-0 transform -translate-x-1/2 z-[21]",
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    e.O(0, [952, 304, 856, 240, 433, 816, 805, 441, 517, 358], () => t(4356)),
      (_N_E = e.O());
  },
]);
